    ...
    <script>
        $(document).ready(function() {
            $("#login_member").click(function() {
                ...
                // 加上相對路徑
                // var relativePath = "../login.php";

                // 合併網址
                // var newUrl = currentUrl + relativePath;

                // 使用 window.location.href 進行網址轉向
                window.location.href =
                    "<?php echo 'http://' . $_SERVER['SERVER_NAME']; ?>/healthylife/view/login.php";
            });
        });
    </script>